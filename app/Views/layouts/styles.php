...
<link rel="stylesheet" href="<?= base_url('assets/vendor/libs/select2/select2-bootstrap-5-theme.min.css') ?>" />
...
<link rel="stylesheet" href="<?= base_url('assets/vendor/libs/daterangepicker/daterangepicker.css') ?>" />
<link href="<?= base_url('assets/vendor/libs/dataTables/datatables.css') ?>" rel="stylesheet">
