...
<head>
    ...
    <meta name="regi_button" content="เว็บพนันออนไลน์อันดับ 1">
                    ...
                    <div class="card">
                        <div class="card-body ">
                                ...
                                <div class="col-12 pd_two_button">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="tel" onkeypress="handle(event)"
                                            placeholder="เบอร์โทรศัพท์มือถือ" name="username" id="login_username"
                                            autocomplete="username" autofocus="autofocus" class="form-control  ">
                                    </div>
                                </div>
                                <div class="col-12 pd_two_button">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend"><span id="inputGroupPrepend2"
                                            ...
                                            autofocus="autofocus" onkeypress="handle(event)" class="form-control  "
                                            style="border-radius: 0px 0.25rem 0.25rem 0px;"> <span class="eyes"><i
                                                id="eye" class="fas fa-eye-slash"></i></span>
                                    </div>
                                </div>
                                <div class="col-12">
                            ...
                            <div class="col-12 tx-center mt-4 tx_white">
                                <p>
                                    Copyright <?= date("Y"); ?> © เว็บพนันออนไลน์ อันดับ 1
                                    All Rights Reserved.
                                </p>
                            </div>
                        </div>
