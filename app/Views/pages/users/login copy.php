                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center mb-0">
                            <!-- <img src="/logo.png" width="60%" alt="" srcset=""> -->
                        </div>
                        ...
                        <div class="mb-3 mt-4 d-flex justify-content-center">
                            <a class="btn btn-success text-dark d-grid w-50"
                                href="<?= $link; ?>"><?= lang("line.pages.login.text.btn-login") ?></a>
                        </div>

                        <div class="mb-3">
                            <form id="formAuthentication" action="javascript:;" method="POST">
                                <div class="mb-3">
